...
namespace SQLCompact
{
    ...
    /// </summary>
    public partial class SQLCEEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new SQLCEEntities object using the connection string found in the 'SQLCEEntities' section of the application configuration file.
        /// </summary>
        public SQLCEEntities() : base("name=SQLCEEntities", "SQLCEEntities")
        {
        ...
        /// <summary>
        /// Initialize a new SQLCEEntities object.
        /// </summary>
        public SQLCEEntities(string connectionString) : base(connectionString, "SQLCEEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new SQLCEEntities object.
        /// </summary>
        public SQLCEEntities(EntityConnection connection) : base(connection, "SQLCEEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
