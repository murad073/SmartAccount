...
namespace BLL.VoucherManagement
{
    internal class VoucherBaseManager
    {
        ...
        public VoucherBaseManager(IRecordRepository dalVoucherManager, IProjectRepository dalProjectManager,
                              IHeadRepository dalHeadManager, VoucherBase voucher = null)
        {
        ...
        public bool IsValid(VoucherBase voucher)  // TODO: Moved to VoucherBase
        {
            ...
            //else if (string.IsNullOrWhiteSpace(voucher.VoucherTypeKey) || voucher.VoucherSerialNo <= 0 ||
            //         !_dalRecordRepository.IsRecordFound(voucher.VoucherTypeKey, voucher.VoucherSerialNo))
            //{
            //    isValid = false;
            //    _message = MessageService.GetErrorMessage("Invalid Voucher number cannot be accepted.");
            //}
